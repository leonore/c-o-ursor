...
class Course:
    ...
    def __init__(self, name, acronym, strand, clashes=None, req=None, comment=None):
        self.name = name
...
def make_course(name, acronym, strand, clashes=None, req=None, comment=None):
    course = Course(name, acronym, strand, clashes, req, comment)
    return course
...
for line in lines:
    ...
    if line == "\n":
        make_course(name, acronym, strand, clashes, req, comment)
        name, acronym, strand, clashes, req, comment = [None] * 6
        continue
    elif line[0] == "N":
